...
public class VideoParseH264Activity extends BaseActivity {
    ...
    private String filePath = Constants.VIDEO_PATH + "yuv_to_h264.h264";
    @SuppressLint("HandlerLeak")
    private Handler mHandler = new Handler() {
        @Override
        public void handleMessage(Message msg) {
            super.handleMessage(msg);
            Toast.makeText(VideoParseH264Activity.this, "播放结束!", Toast.LENGTH_LONG).show();
        }
    };
    ...
    private void init() {
        ...
        mSurface = findViewById(R.id.sf_camera);
