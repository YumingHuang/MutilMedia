...
public class VideoRawRecordActivity extends BaseActivity implements SurfaceHolder.Callback,
    ...
    private void startPreview() {
        ...
        try {
            ...
            Log.d(TAG, "previewSize.width = " + previewSize.width + " ,previewSize.height = " +
                    previewSize.height);
        ...
        public void encoderYUV420(byte[] input) {
            try {
                ...
                if (inputBufferIndex >= 0) {
                    ...
                    codec.queueInputBuffer(inputBufferIndex, 0, input.length, System.currentTimeMillis
                            (), 0);
                }
